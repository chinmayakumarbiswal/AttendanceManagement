...
public class TeacherRegistration extends JFrame {
    ...
    public TeacherRegistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("New Teacher Register");
        ...
        tid.setBounds(707, 151, 228, 50);
        contentPane.add(tid);
        tid.setColumns(10);

        JLabel TecherID = new JLabel("Teacher Id");
        TecherID.setFont(new Font("Tahoma", Font.PLAIN, 20));
        TecherID.setBounds(542, 159, 99, 29);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    String query = "INSERT INTO teacher values('"+first_name+"','"+last_name+"','"+teacher_id+"','"+email_id+"','"+password+"')";
